...
| [Openness read coverage roadmap](roadmap/openness-read-coverage.md) | Phased R0–R6 widening of the read surface: generic object reads, then PLC, hardware, library, HMI, and governance reads |
...
Latest process entries: [R5 governance reads (`governance_read`) design](superpowers/specs/2026-09-25-r5-governance-read-design.md)
...
and its [implementation plan](superpowers/plans/2026-09-25-r4-hmi-read.md);
[R3 library reads (`library_read`) design](superpowers/specs/2026-09-25-r3-library-read-design.md)
and its [implementation plan](superpowers/plans/2026-09-25-r3-library-read.md);
[R2 hardware reads design](superpowers/specs/2026-09-25-r2-hardware-read-design.md)
...
its [implementation plan](superpowers/plans/2026-09-25-r0-object-read.md), and
[its read-only live acceptance report](superpowers/acceptance/reports/2026-09-25-r0-object-read-live.md);
